...
story += [HR_gold()]
story += [s(4)]
story += [Paragraph("THE Z PROTOCOL  --  v3", euler_sub)]
...
story += [frozen("TABLE Z14  --  BIBLIOGRAPHIA  --  2026-06-06  --  SHA: " + _z14_sha[:8] + "  --  SORRY: 0")]
story += [s(6)]
...
story += [Paragraph("Date: June 06, 2026", cert_style2)]
