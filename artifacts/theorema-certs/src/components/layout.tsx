    ...
    <div className="min-h-[100dvh] flex flex-col md:flex-row bg-background">
      ...
      <aside className="w-full md:w-64 border-r border-border bg-sidebar flex-shrink-0 flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-1">
          ...
          <Link href="/desert-map" className={`flex items-center gap-3 px-3 py-2 text-sm font-mono transition-colors ${location === "/desert-map" ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:bg-muted hover:text-foreground"}`} data-testid="link-desert-map">
            <Map className="w-4 h-4" />
            <span>Desert Map</span>
          </Link>
          <Link href="/hodge" className={`flex items-center gap-3 px-3 py-2 text-sm font-mono transition-colors ${location === "/hodge" ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:bg-muted hover:text-foreground"}`} data-testid="link-hodge">
