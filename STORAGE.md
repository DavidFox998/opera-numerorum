...
|------------|------|-----------|
| `certificates/OperaNumerorum_AllCerts.zip` | ~121 MB | https://drive.google.com/file/d/17ZrH7j7X6SsOyb_qVhn4BInKUszRmDFT/view?usp=sharing |
...
| `certificates/OperaNumerorum_Context.zip` | ~655 KB | https://drive.google.com/file/d/1McMIbfjlIR3yrbTOcOqglhlcQYbrIuF1/view?usp=drivesdk |
| `certificates/CertificationChain_2026_06_04.zip` | ~85 KB | https://drive.google.com/file/d/1yFSdmTMO_IuQGuDwuXW-n_yFgci4hLkT/view?usp=drivesdk |
| `certificates/ExtendedTheory_2026_06_06.zip` | ~6 MB | https://drive.google.com/file/d/1o-XFiSeVu-p51U_O2gPqIyHiaxV5dy4G/view?usp=sharing |
| `certificates/Essays_Appendices_2026_06_06.zip` | ~12 MB | https://drive.google.com/file/d/11uzvs55F6weTLmJzbWjdqwh0BULPYPNS/view?usp=sharing |

### Aureum structured folder on Google Drive

The Aureum content (zero-sorry PDFs, Lean proofs, manifests) is
organised into act-level subfolders under a parent folder:

| Folder | Drive URL |
|--------|-----------|
| `AUREUM_20260606` (parent, Drive folder name unchanged) | https://drive.google.com/drive/folders/1jXSQNCvmXbImp2iqrQNHms8XkKJ8A6DB |
| `00_PROLOGUE_CONTEXT (4 PDFs)` | https://drive.google.com/drive/folders/13uudlLcYnXInWHq-1ChqHsga3U0t3CIX |
| `01_ACT1_CLAY_COMPUTATIONAL_CERTIFICATES (10 PDFs)` | https://drive.google.com/drive/folders/16Mg_aEBf7cqNaWsE8iO4PEVHF9Rd0Dbu |
...
| `MANIFESTS (STORY_MANIFEST.csv + SORRY_MAP.csv...)` | https://drive.google.com/drive/folders/1Z1tqm599kpqlIYBUxiDSzLlUSg8R79Xh |

### OperaNumerorum_Blocks structured folder on Google Drive

| Folder / File | Drive URL |
|---------------|-----------|
| `OperaNumerorum_Blocks_20260606` (parent) | https://drive.google.com/drive/folders/1bstsbZwLtInP7JMf92ddLTNl4SO7h5z9 |
| `CLAY_SEALED_BLOCK/CLAY_CLAY_SEALED.zip` | https://drive.google.com/file/d/1EAQrpYCfdOWFYm3nN6s8G05uuGVzS8-X |
| `M_FINAL/M_FINAL.zip` | https://drive.google.com/file/d/1BDvpSKJxeFZ-FqqNOioI8KzfsPyxAJT7 |
| `M_DRAFT/M_DRAFT.zip` | https://drive.google.com/file/d/14BYrlv-fdeMeO7Jh-FosXndYvP0cv2K0 |
| `HISTORICAL/HISTORICAL.zip` | https://drive.google.com/file/d/1Rtg7WVJpkIKkpX6uYIvCWks1WaCUqoIS |

### Individual files uploaded to Drive (addenda)

| File | Drive URL |
|------|-----------|
| `MorningStar_Engineering_Spec_V1.pdf` | https://drive.google.com/file/d/1U8OtgP7zRHtiPJD1pKUVwCvauNQFiNGE/view |
...
| `AUREUM_REPO.tar.gz` (previously MORNING_STAR_REPO.tar.gz) | https://drive.google.com/file/d/1El43TE20wrdRuqdg40qZdI9-CfvqwyMO/view?usp=drivesdk |
...
*Section auto-generated by `certificates/build_storage_doc.py` -- last updated 2026-06-06T21:39:58Z.*
